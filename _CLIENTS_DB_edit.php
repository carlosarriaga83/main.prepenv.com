...
<?php 	
	...
	$q = sprintf("SELECT * FROM CLIENTS WHERE id = '%s'   ", $id );  // echo $q . "\n";
	$R1 = SQL_2_OBJ_V2($q);
	//print_r($R1);die;
                    ...
                    <div class="user-grid-card position-relative border radius-16 overflow-hidden bg-base h-100">
                        ...
                        <div class="pb-24 ms-16 mb-24 me-16  mt--100">
                            <div class="text-center border border-top-0 border-start-0 border-end-0">
                                <img src="<?php echo $CLIENTE['CLIENTE_PIC']; ?>" alt="" class="border br-white border-width-2-px w-200-px h-200-px rounded-circle object-fit-cover">
                            ...
                            <div class="mt-24">
                                ...
                                <ul>
									...
									<li class="d-flex align-items-center gap-1 mb-12">
                                        ...
                                        <span class="w-70 text-secondary-light fw-medium">: <?php echo $CLIENTE['ADDRESS']; ?></span>
                                    </li>
									<li class="d-flex align-items-center gap-1 mb-12">
									...
									<li class="d-flex align-items-center gap-1 mb-12">
                                        ...
                                        <span class="w-70 text-secondary-light fw-medium">: <?php echo $CLIENTE['stripe_cus_id']; ?></span>
                                    </li>
									

                                    <li class="d-flex align-items-center gap-1">
                                        <span class="w-30 text-md fw-semibold text-primary-light"> Descripcion</span>
                                        <span class="w-70 text-secondary-light fw-medium">: <?php echo $CLIENTE['DESCRIPCION']; ?></span>
                                    </li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="card-body p-24">
                            ...
                            <div class="tab-content" id="pills-tabContent">
                                <div class="tab-pane fade show active" id="pills-edit-profile" role="tabpanel" aria-labelledby="pills-edit-profile-tab" tabindex="0">
                                    ...
                                    <!-- Upload Image End -->
                                    <form id="FRM_USER_PROFILE" action="#" FRM="FRM_USER_PROFILE" DB="CLIENTS">
										<input type="text" name="EDIT_ID" value="<?php echo $CLIENTE['ID']; ?>" readonly>
										<img id="CLIENTE_PIC" name="CLIENTE_PIC" src="<?php echo $CLIENTE['CLIENTE_PIC']; ?>" class="mb-24 mt-16" hidden></img>
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <div class="mb-20">
                                                    <label for="name" class="form-label fw-semibold text-primary-light text-sm mb-8">Name <span class="text-danger-600">*</span></label>
                                                    <input type="text" class="form-control radius-8" id="name" placeholder="Enter Cliente Name"  name="NAME"  value="<?php echo $CLIENTE['NAME']; ?>" required='required'>
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                                <div class="mb-20">
                                                    ...
                                                    <input type="email" class="form-control radius-8" id="email" placeholder="Email"  name="EMAIL"  value="<?php echo $CLIENTE['EMAIL']; ?>" required='required'>
                                                </div>
                                            </div>		
                                            ...
                                            <div class="col-sm-6">
                                                <div class="mb-20">
                                                    ...
                                                    <input type="phone" class="form-control radius-8" id="phone" placeholder="10 dígitos"  name="PHONE"  value="<?php echo $CLIENTE['PHONE']; ?>" >
                                                </div>
                                            </div>												
                                            <div class="col-sm-6">
                                                <div class="mb-20">
                                                    <label for="RFC" class="form-label fw-semibold text-primary-light text-sm mb-8">RFC<span class="text-danger-600"></span></label>
                                                    <input type="text" class="form-control radius-8" id="RFC" placeholder="ABC010203AB9"  name="RFC"  value="<?php echo $CLIENTE['RFC']; ?>" >
                                                </div>
                                            </div>
                                            <div class="col-sm-12">
                                                <div class="mb-20">
                                                    <label for="address" class="form-label fw-semibold text-primary-light text-sm mb-8">Dirección</label>
                                                    <textarea class="form-control radius-8" id="address" placeholder="Dirección" name="ADDRESS" ><?php echo $CLIENTE['ADDRESS']; ?></textarea>
                                                </div>
                                            </div>
                                            <div class="col-sm-12">
                                                <div class="mb-20">
                                                    <label for="desc" class="form-label fw-semibold text-primary-light text-sm mb-8">Descripción</label>
                                                    <textarea class="form-control radius-8" id="desc" placeholder="Write description..." name="DESCRIPCION" ><?php echo $CLIENTE['DESCRIPCION']; ?></textarea>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-switch switch-primary py-12 px-16 border radius-8 position-relative mb-16">
                                                    ...
                                                    <div class="d-flex align-items-center gap-3 justify-content-between">
                                                        ...
                                                        <?php $CLIENTE['OPT_VEGETARIANO'] == 'on' ? $CHECKED = 'checked' : $CHECKED = ''; ?>
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-switch switch-primary py-12 px-16 border radius-8 position-relative mb-16">
                                                    ...
                                                    <div class="d-flex align-items-center gap-3 justify-content-between">
                                                        ...
                                                        <?php $CLIENTE['OPT_VEGANO'] == 'on' ? $CHECKED = 'checked' : $CHECKED = ''; ?>
                                ...
                                <div class="tab-pane fade" id="pills-change-passwork" role="tabpanel" aria-labelledby="pills-change-passwork-tab" tabindex="0">
                                    <form id="FRM_USER_PROFILE_PWD" action="#" FRM="FRM_USER_PROFILE_PWD" DB="CLIENTS">
                                    <input type="text" name="EDIT_ID" value="<?php echo $CLIENTE['ID']; ?>">
