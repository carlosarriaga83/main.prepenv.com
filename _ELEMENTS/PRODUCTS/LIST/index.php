																		...
																		<div class="  col-12 ">
																			...
																			<ul>
																				...
																				<li class="d-flex align-items-center gap-1 mb-0">
																					<span class="w-100 text-sm fw-bold text-primary-light">{$row['NAME']}</span>
																					
																				</li>
																																						
																				<li class="d-flex align-items-center gap-1 ms-5">
																					<span class="w-30 text-sm fw-semibold text-secondary-light"></span>
																		...
																		<div class="  col-6 border border-bottom-0 border-start-0 border-end-0 ">
																			<ul>
																				...
																				<li class="d-flex align-items-cente gap-1 mb-0">
																					<span class="w-30 text-sm fw-semibold text-secondary-light">Descripción</span>
																					<span class="w-70 text-secondary-light fw-medium">: {$row['DESCRIPCION']}</span>
																				</li>
