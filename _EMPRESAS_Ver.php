...
<?php
	...
	$q = sprintf("SELECT * FROM u124132715_DB.CLIENTS");  //echo $q . "\n";
	$R1 = SQL_2_OBJ_V2($q);
...
<?php 
	$T_PARAMS 					= [];
	$T_PARAMS['DB']['TABLE'] 	= 'Empresas';
	$T_PARAMS['DB']['COLS'] 	= [  'empresa', 'sucursal', 'correo', 'contacto', 'telefono', 'Action'];
	
	$T_PARAMS['TABLE']['ID'] 	= 'TBL_1';
	$T_PARAMS['TABLE']['COLS'] 	= [  'Empresa', 'Sucursal', 'Correo', 'Contacto', 'Telefono', 'Action'];
	$T_PARAMS['TABLE']['href'] 	= '_EMPRESAS_edit.php';
	
	$T_PARAMS['TABLE']['SEARCH_BAR']	 	= true;
	$T_PARAMS['TABLE']['ADD_NEW']['TEXT'] 	= 'Agregar empresa';
	$T_PARAMS['TABLE']['ADD_NEW']['href'] 	= '_EMPRESAS_edit.php';
	
	//$T_PARAMS['TABLE']['HEADERS']['PRIORITY']	= ['NAME', 'Action'];



	include './_ELEMENTS/EMPRESAS/LIST/index.php';
