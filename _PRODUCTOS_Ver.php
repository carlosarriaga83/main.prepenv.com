        ...
        <div class="dashboard-main-body">
            <div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
                ...
                <ul class="d-flex align-items-center gap-2">
                    ...
                    <li>-</li>
                    <li class="fw-medium">Productos</li>
								...
								<?php 
									...
									$T_PARAMS['DB']['COLS'] 	= [  'name' , 'description','default_price','active', 'Action'];
									
									$T_PARAMS['TABLE']['ID'] 	= 'TBL_1';
									$T_PARAMS['TABLE']['COLS'] 	= [ 'Producto' , 'Descripción','default_price','Activo', 'Action'];
									$T_PARAMS['TABLE']['href'] 	= '_PRODUCTOS_edit.php';

									$T_PARAMS['TABLE']['SEARCH_BAR']	 	= true;
									$T_PARAMS['TABLE']['ADD_NEW']['TEXT'] 	= 'Add new';
									$T_PARAMS['TABLE']['ADD_NEW']['href'] 	= '_PRODUCTOS_edit.php';
									$T_PARAMS['TABLE']['ADD_NEW']['MISC_PROPS'] 	= 'data-bs-toggle="modal" data-bs-target="#Modal_1"';
									

									//echo DB_2_TABLE_V3($T_PARAMS ); 

									include './_ELEMENTS/PRODUCTS/FROM_STRIPE/index.php';
			...
			<div class="col-sm-12 d-none">
				<div class="table-responsive scroll-m">
					<table class="table bordered-table-sm text-sm" id="TABLE_STRIPE_1" >
						...
						<tbody>
						<?php echo TABLE_ROWS_1($PRODUCTS_STRIPE); ?>
						</tbody>
					</table>
				</div>
