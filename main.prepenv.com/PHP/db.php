...
CREATE TABLE IF NOT EXISTS `usuarios` (
  ...
  `default_parking_id` int(11) DEFAULT NULL,
  `email` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `telefono` (`telefono`),
  KEY `default_parking_id` (`default_parking_id`),
  CONSTRAINT `usuarios_ibfk_1` FOREIGN KEY (`default_parking_id`) REFERENCES `parking_lots` (`id`) ON DELETE SET NULL
